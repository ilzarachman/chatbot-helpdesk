...
async def embed_save_question(question: str, answer: str, category: Intent, public: bool):
    """
    ...
    Returns:
        None
    """
    logger.debug(f"Embedding question: {question}, answer: {answer}, category: {category}, public: {public}")
...
async def answer_question(
    ...
    try:
        ...
        raise HTTPException(
            detail="Invalid intent. Please use one of the following intents: " + ", ".join([str(i) for i in Intent]),
